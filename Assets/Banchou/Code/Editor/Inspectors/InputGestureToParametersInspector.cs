...
namespace Banchou.Pawn.FSM {
    ...
    public class InputGestureToParametersInspector : Editor {
        ...
        private SerializedProperty _acceptanceConditions;
        private SerializedProperty _bufferConditions;
        ...
        private void OnEnable() {
            ...
            _acceptanceConditions = serializedObject.FindProperty("_acceptanceConditions"); 
            _bufferConditions = serializedObject.FindProperty("_bufferConditions");
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.PropertyField(_acceptanceConditions);
            ...
            EditorGUILayout.PropertyField(_bufferConditions);
            if (_inNormalizedTime.boolValue) {
